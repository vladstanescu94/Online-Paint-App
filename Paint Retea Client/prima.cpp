      ...
      TShiftState Shift, int X, int Y)
{
     ...
     if(fMain->tLinie->Down)
     {
       ...
       AnsiString bufferClient = "Linie" + AnsiString(".") +IntToStr(StartX)+ AnsiString(".") +  IntToStr(StartY)+ AnsiString(".") + IntToStr(X)+ AnsiString(".") + IntToStr(Y) +AnsiString(".")+ ColorToString(tColorBox->Selected)+ AnsiString(".") +  IntToStr(tTrackBar->Position);
     ...
     if(fMain->tCerc->Down)
     {
        ...
        AnsiString bufferClient = "Cerc" + AnsiString(".") +IntToStr(StartX)+ AnsiString(".") +  IntToStr(StartY)+ AnsiString(".") + IntToStr(X)+ AnsiString(".") + IntToStr(Y) +AnsiString(".")+ ColorToString(tColorBox->Selected)+ AnsiString(".") +  IntToStr(tTrackBar->Position);
        cSocket->Socket->SendText(bufferClient);
        c->draw();
        delete c;
     }
     if(fMain->tPatrat->Down)
     {
        ...
        fMain->Canvas->Brush->Style = bsClear;
        AnsiString bufferClient = "Patrat" + AnsiString(".") +IntToStr(StartX)+ AnsiString(".") +  IntToStr(StartY)+ AnsiString(".") + IntToStr(X)+ AnsiString(".") + IntToStr(Y) +AnsiString(".")+ ColorToString(tColorBox->Selected)+ AnsiString(".") +  IntToStr(tTrackBar->Position);
        cSocket->Socket->SendText(bufferClient);
        p->draw();
        delete p;
     }
      ...
      int X, int Y)
{
      ...
      if(fMain->tPensula->Down)
      {
           if((GetKeyState(VK_LBUTTON) & 0x100) != 0)
           {
             ...
             AnsiString bufferClient = "Pensula" + AnsiString(".") +IntToStr(StartX)+ AnsiString(".") +  IntToStr(StartY)+ AnsiString(".") + IntToStr(X)+ AnsiString(".") + IntToStr(Y) +AnsiString(".")+ ColorToString(tColorBox->Selected)+ AnsiString(".") +  IntToStr(tTrackBar->Position);
             cSocket->Socket->SendText(bufferClient);
             Canvas->LineTo(X,Y);
           }
